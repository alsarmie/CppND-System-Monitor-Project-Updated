...
unsigned long long LinuxParser::MemoryUtilization() {
  string line, key, unit;
  unsigned long long mem_total{0}, mem_free{0.0};
  unsigned long long mem_utilization{0.0};
  string keyword[2]{"MemTotal:", "MemFree:"};
  ...
  mem_utilization = mem_total - mem_free;

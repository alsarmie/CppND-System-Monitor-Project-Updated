...
long LinuxParser::ActiveJiffies() {
  ...
  stream.close();
  return jiffies[CPUFields::kUser_] +
              jiffies[CPUFields::kNice_] +
              jiffies[CPUFields::kSystem_] +
              jiffies[CPUFields::kIRQ_] +
              jiffies[CPUFields::kSoftIRQ_] +
              jiffies[CPUFields::kSteal_];
}

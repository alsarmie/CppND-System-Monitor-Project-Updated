...
float Processor::Utilization() {
  ...
  prev_non_idle_=prev_agg_cpu_values[CPUFields::kUser_]+prev_agg_cpu_values[CPUFields::kNice_]+prev_agg_cpu_values[CPUFields::kSystem_]+prev_agg_cpu_values[CPUFields::kIRQ_]+prev_agg_cpu_values[CPUFields::kSoftIRQ_]+prev_agg_cpu_values[CPUFields::kSteal_]    
  //  History

...
float Processor::Utilization() {
  ...
  non_idle_=agg_cpu_values[CPUFields::kUser_]+agg_cpu_values[CPUFields::kNice_]+agg_cpu_values[CPUFields::kSystem_]+agg_cpu_values[CPUFields::kIRQ_]+agg_cpu_values[CPUFields::kSoftIRQ_]                 
  //  History
